    ...
    <div className="min-h-screen bg-custom-black text-white relative overflow-hidden">
      ...
      <div className="w-full py-10">
        ...
        <div className="mb-16 px-8">
          ...
          <p className="text-2xl lg:text-2xl leading-relaxed text-gray-300">
        ...
        <div className="px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {skills.map((skill, index) => (
              <div 
                key={skill}
                className="relative bg-[#2D2D2D] backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 hover:border-custom-purple/50 transition-all duration-300 group"
              >
                ...
                <div className="absolute -top-0 -left-0 z-10">
                  <img 
                    ...
                    className="w-14 h-14 opacity-25 group-hover:opacity-80 transition-opacity duration-300"
                  />
                </div>
